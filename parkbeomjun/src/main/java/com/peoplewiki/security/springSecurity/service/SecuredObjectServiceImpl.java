package com.peoplewiki.security.springSecurity.service;
...
import com.peoplewiki.security.springSecurity.persistence.SecuredObjectDaoImpl;

public class SecuredObjectServiceImpl implements SecuredObjectService {

	private SecuredObjectDaoImpl securedObjectDao;

	public SecuredObjectDaoImpl getSecuredObjectDao() {
		return securedObjectDao;
	}

	public void setSecureObjectDao(SecuredObjectDaoImpl secureObjectDao) {
