package application.sample.tree;
...
public class MyApplicationClass extends Application {
	...
	public void start(final Stage stage) throws Exception {
		...
		// demonstrates using controller methods to manipulate the controlled
		// UI.
...
//		stage.getIcons().add(new Image(getClass().getResourceAsStream("myIcon.png")));
	...
	// main method is only for legacy support - java 8 won't call it for a
	// javafx application.
